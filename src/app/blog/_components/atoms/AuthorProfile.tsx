...
export const AuthorProfile = ({ name, email, avatar }: AuthorProfileProps) => (
  <div className="flex flex-col items-center pt-5 flex-row md:max-w-xl hover:bg-gray-100">
    <Image
      src={avatar}
      alt={name || "author"}
      width={0}
    ...
    <div className="flex flex-col justify-between pl-5 md:pl-10 leading-normal">
      <p className="max-sm:text-2xl text-4xl font-bold tracking-tight text-gray-900">
        {name}
      </p>
